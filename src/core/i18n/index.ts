...
const en: Catalog = {
  ...
  "cli.opt.reviewJson": "emit findings as a JSON object {blocking,warnings,suggestions} instead of Markdown",
  ...
  "models.legend": "🛠 = native tools · prices = USD per 1M tokens (in/out) · sort by: price, context, popularity, name",
...
const ptBR: Catalog = {
  ...
  "cli.opt.reviewJson": "emite os achados como objeto JSON {blocking,warnings,suggestions} em vez de Markdown",
  ...
  "models.legend": "🛠 = tools nativas · preços = USD por 1M tokens (entrada/saída) · ordenar por: preço, contexto, popularidade, nome",
  "models.colTools": "TOOLS",
